...
app.put('/update', authorize(['customer', 'tech', 'admin']), authCtrl.update);
...
app.put('/api/removeEquipFromRenter/:id', authorize(['customer', 'tech', 'admin']), renterCtrl.removeEquip);
...
app.put('/api/markReservationCanceled/:id', authorize(['customer', 'tech', 'admin']), function(req, res) {
  Reservation.findByIdAndUpdate(req.params.id, { status: 'canceled', checkedIn: '' }, { new: true })
    .populate('createdBy', '-password')
    .populate('renters')
    .exec(function(err, reservation) {
      if (err) res.send(err);
...
// EQUIPMENT
app.get('/api/equipment', authorize(['tech', 'admin', 'customer']), equipmentCtrl.getEquipment);
app.get('/api/equipment/:id', authorize(['tech', 'admin']), equipmentCtrl.getEquipmentById);
...
app.post('/api/equipment/:id', authorize(['tech', 'admin']), equipmentCtrl.addRepair);
app.put('/api/equipment/checkout/:id', authorize(['tech', 'admin']), equipmentCtrl.checkOut);
app.put('/api/equipment/checkin/:id', authorize(['tech', 'admin']), equipmentCtrl.checkIn);
